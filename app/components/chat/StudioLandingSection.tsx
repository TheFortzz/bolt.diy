  ...
  return (
    <div className="w-full flex flex-col items-center select-none pb-12">
      ...
      <div className="text-center px-4 pt-10 pb-4 max-w-4xl mx-auto">
        {/* Top Glowing Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 border border-cyan-400/30 text-[11px] font-bold tracking-widest text-cyan-300 uppercase shadow-[0_0_15px_rgba(6,182,212,0.25)] backdrop-blur-md mb-4 animate-fade-in">
